...
import os
import tempfile
from ethical_anomaly import predict_video

st.set_page_config(page_title="Ethical Anomaly Detection", layout="centered")

# Title
st.title("🔍 Ethical Anomaly Detection")
st.write("Upload a video and the model will classify it as **Normal** or **Anomalous**.")
...
if uploaded_file:
    ...
    if st.button("🔍 Analyze Video"):
        ...
        if result:
            ...
            if result == "Anomaly":
                st.warning("⚠️ This video contains **anomalous activity**.")
            else:
